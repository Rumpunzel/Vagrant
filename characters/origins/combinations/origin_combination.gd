...
static func find_combination(selected_origins: Array[Origin]) -> OriginCombination:
	var combination_files: Array[String] = Files.list_all_files("res://characters/origins/combinations/", true, func(file_name: String) -> bool: return file_name.get_extension() == "tres")
